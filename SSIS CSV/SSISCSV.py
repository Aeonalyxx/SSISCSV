...
class AddStudentDialog(QtWidgets.QDialog):
    def __init__(self, course_ids, parent=None):
        ...
        self.course_combobox.addItems(self.course_ids)  
...
class EditStudentDialog(QtWidgets.QDialog):
    ...
    def __init__(self, student_data, course_ids, parent=None):
        super().__init__(parent)
    ...
    def update_student_data(self, edited_student_data):
        ...
        for i, row in enumerate(existing_data):
            if row == self.original_student_data:
                existing_data[i] = edited_student_data
...
#STUDENTS TAB =================================================================================================
    ...
    #STUDENT SEARCH BAR
        ...
        self.StudentIDLineEdit.setGeometry(QtCore.QRect(120, 510, 210, 31))
        font = QtGui.QFont()
    ...
    #SEARCH STUDENT BUTTON
        ...
        self.SearchStudentIDButton.setGeometry(QtCore.QRect(329, 510, 93, 31))
        font = QtGui.QFont()
    ...
    #STUDENT FILTER BOX
        ...
        self.StudentfilterComboBox.setGeometry(QtCore.QRect(10, 510, 110, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
...
#COURSE TAB =================================================================================================
    ...
    #SEARCH COURSE ID BUTTON
        ...
        self.SearchCourseIDButton.setGeometry(QtCore.QRect(329, 510, 93, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    #COURSE SEARCH BAR
        ...
        self.CourseIDLineEdit.setGeometry(QtCore.QRect(120, 510, 210, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
    ...
    #FILTER BOX
        ...
        self.CoursefilterComboBox.setGeometry(QtCore.QRect(10, 510, 110, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
...
# FOR STUDENT ====================================================================================================
    ...
    def search_students(self):
        ...
        if not matches_found:
            if filter_option == "Student ID":
                QtWidgets.QMessageBox.warning(self.StudentIDLineEdit, "No Match", "No student found with the given Student ID.")
            elif filter_option == "Name":
                QtWidgets.QMessageBox.warning(self.StudentIDLineEdit, "No Match", "No student found with the given Name.")
            elif filter_option == "Gender":
                QtWidgets.QMessageBox.warning(self.StudentIDLineEdit, "No Match", "No student found with the given Gender")
            elif filter_option == "Course Code":
                QtWidgets.QMessageBox.warning(self.StudentIDLineEdit, "No Match", "No student found with the given Course Code")
            elif filter_option == "Year":
                QtWidgets.QMessageBox.warning(self.StudentIDLineEdit, "No Match", "No student found with the given Year")
    ...
    def open_add_student_dialog(self):
        course_ids = [self.CourseTable.item(row, 0).text() for row in range(self.CourseTable.rowCount())]
        dialog = AddStudentDialog(course_ids)
        if dialog.exec_():
    ...
    def open_edit_student_dialog(self):
        ...
        if selected_row >= 0:
            ...
            dialog = EditStudentDialog(student_data, course_ids)
...
# FOR COURSE =================================================================================================
    ...
    def delete_course(self):
        ...
        if selected_row >= 0:
            ...
            confirmation = QtWidgets.QMessageBox.question(self.centralwidget, "Confirmation", "Are you sure you want to delete this course and all associated students?",
                                                        QtWidgets.QMessageBox.Yes | QtWidgets.QMessageBox.No)
            if confirmation == QtWidgets.QMessageBox.Yes:
                deleted_students = []
                for row in reversed(range(self.StudentTable.rowCount())):
                    course_item = self.StudentTable.item(row, 3)  
                    if course_item and course_item.text() == course_id:
                        student_id_item = self.StudentTable.item(row, 0)
                        if student_id_item:
                            deleted_students.append(student_id_item.text())
                        self.StudentTable.removeRow(row)
                if course_id_item is not None:
                    self.CourseTable.removeRow(selected_row)
                    self.update_csv_file_for_courses(course_id)
                    for student_id in deleted_students:
                        self.update_csv_file_for_students(student_id)

                QtWidgets.QMessageBox.information(self.centralwidget, "Information", "Course and associated students deleted.")
        else:
            QtWidgets.QMessageBox.information(self.centralwidget, "Information", "Please select a row to delete.")
